...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _messages = {
    'uz-latn': {
      ...
      'chat.title': 'Logist bilan chat',
      'chat.placeholder': 'Xabar yozing…',
      'chat.send': 'Yuborish',
      'chat.photo': 'Foto',
      'chat.empty': 'Hozircha xabar yo\'q',
      'chat.photoUnavailable': 'Fotoni ochib bo\'lmadi',
      'chat.noTrip': 'Chat faol reysga bog\'lanadi',
      'rating.title': 'Reytingim',
      'rating.pending': 'Reyting uchun reys hali yetarli emas',
      'rating.trips': 'Reyslar',
      'rating.late': 'Kechikkan',
      'rating.fuel': 'Yoqilg\'i farqi',
      'rating.breakdowns': 'Nosozlik',
    ...
    'uz-cyrl': {
      ...
      'chat.title': 'Логист билан чат',
      'chat.placeholder': 'Хабар ёзинг…',
      'chat.send': 'Юбориш',
      'chat.photo': 'Фото',
      'chat.empty': 'Ҳозирча хабар йўқ',
      'chat.photoUnavailable': 'Фотони очиб бўлмади',
      'chat.noTrip': 'Чат фаол рейсга боғланади',
      'rating.title': 'Рейтингим',
      'rating.pending': 'Рейтинг учун рейс ҳали етарли эмас',
      'rating.trips': 'Рейслар',
      'rating.late': 'Кечиккан',
      'rating.fuel': 'Ёқилғи фарқи',
      'rating.breakdowns': 'Носозлик',
    ...
    'ru': {
      ...
      'chat.title': 'Чат с логистом',
      'chat.placeholder': 'Написать сообщение…',
      'chat.send': 'Отправить',
      'chat.photo': 'Фото',
      'chat.empty': 'Сообщений пока нет',
      'chat.photoUnavailable': 'Не удалось открыть фото',
      'chat.noTrip': 'Чат привязан к активному рейсу',
      'rating.title': 'Мой рейтинг',
      'rating.pending': 'Рейсов пока недостаточно для рейтинга',
      'rating.trips': 'Рейсы',
      'rating.late': 'Опоздания',
      'rating.fuel': 'Отклонение топлива',
      'rating.breakdowns': 'Поломки',
