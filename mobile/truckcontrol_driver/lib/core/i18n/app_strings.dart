...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _messages = {
    'uz-latn': {
      ...
      'error.ODOMETER_INVALID': 'Spidometr ko\'rsatkichi reys boshidagidan kichik. Raqamni tekshiring.',
      'error.TRIP_INVALID_STATUS': 'Reys holati o\'zgargan. Logist bilan bog\'laning.',
      'error.NOT_FOUND': 'Reys topilmadi yoki sizga biriktirilmagan.',
      ...
      'gps.blocked.title': 'Reys kuzatilmayapti',
      'gps.blocked.serviceOff': 'Telefonda joylashuv o\'chirilgan. Sozlamalardan yoqing.',
      'gps.blocked.denied': 'GPS ruxsati berilmagan. Ruxsatsiz marshrut yozilmaydi.',
      'gps.blocked.deniedForever':
          'GPS ruxsati butunlay rad etilgan. Uni faqat ilova sozlamalaridan yoqish mumkin.',
      'gps.blocked.allow': 'Ruxsat berish',
      'gps.blocked.settings': 'Sozlamalar',
    ...
    'uz-cyrl': {
      ...
      'error.ODOMETER_INVALID': 'Спидометр кўрсаткичи рейс бошидагидан кичик. Рақамни текширинг.',
      'error.TRIP_INVALID_STATUS': 'Рейс ҳолати ўзгарган. Логист билан боғланинг.',
      'error.NOT_FOUND': 'Рейс топилмади ёки сизга бириктирилмаган.',
      ...
      'gps.blocked.title': 'Рейс кузатилмаяпти',
      'gps.blocked.serviceOff': 'Телефонда жойлашув ўчирилган. Созламалардан ёқинг.',
      'gps.blocked.denied': 'GPS рухсати берилмаган. Рухсатсиз маршрут ёзилмайди.',
      'gps.blocked.deniedForever':
          'GPS рухсати бутунлай рад этилган. Уни фақат илова созламаларидан ёқиш мумкин.',
      'gps.blocked.allow': 'Рухсат бериш',
      'gps.blocked.settings': 'Созламалар',
    ...
    'ru': {
      ...
      'error.ODOMETER_INVALID': 'Показание одометра меньше, чем в начале рейса. Проверьте число.',
      'error.TRIP_INVALID_STATUS': 'Статус рейса изменился. Свяжитесь с логистом.',
      'error.NOT_FOUND': 'Рейс не найден или не закреплён за вами.',
      ...
      'gps.blocked.title': 'Рейс не отслеживается',
      'gps.blocked.serviceOff':
          'Геолокация выключена на телефоне. Включите её в настройках.',
      'gps.blocked.denied': 'Нет разрешения на GPS. Без него маршрут не записывается.',
      'gps.blocked.deniedForever':
          'Доступ к GPS запрещён навсегда. Включить можно только в настройках приложения.',
      'gps.blocked.allow': 'Разрешить',
      'gps.blocked.settings': 'Настройки',
