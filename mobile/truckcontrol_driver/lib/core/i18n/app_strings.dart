...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _messages = {
    'uz-latn': {
      ...
      'sync.rejected': 'Server qabul qilmadi',
      'sync.failed': 'Yuborib bo\'lmadi',
      'sync.problemBanner': 'Yuborilmagan yozuvlar bor — tekshiring',
      'sync.discard': 'O\'chirish',
      'sync.discardConfirm': 'Bu yozuv butunlay o\'chiriladi. Davom etasizmi?',
    ...
    'uz-cyrl': {
      ...
      'sync.rejected': 'Сервер қабул қилмади',
      'sync.failed': 'Юбориб бўлмади',
      'sync.problemBanner': 'Юборилмаган ёзувлар бор — текширинг',
      'sync.discard': 'Ўчириш',
      'sync.discardConfirm': 'Бу ёзув бутунлай ўчирилади. Давом этасизми?',
    ...
    'ru': {
      ...
      'sync.rejected': 'Сервер отклонил',
      'sync.failed': 'Не удалось отправить',
      'sync.problemBanner': 'Есть неотправленные записи — проверьте',
      'sync.discard': 'Удалить',
      'sync.discardConfirm': 'Запись будет удалена безвозвратно. Продолжить?',
